...
CREATE TABLE COMMON(
    ...
    COMMON_CODE VARCHAR(255) UNIQUE NOT NULL,
...
CREATE TABLE COMMON_CODE(
    ...
    UNIQUE KEY UNIQUE_COMMON_CODE_VALUE (COMMON_CODE, COMMON_VALUE),
    KEY IDX_COMMON_VALUE (COMMON_CODE),
    KEY IDX_COMMON_VALUE_ONLY (COMMON_VALUE) 
);
...
CREATE TABLE TERMS (
    ...
    FOREIGN KEY (COMMON_VALUE) REFERENCES COMMON_CODE(COMMON_VALUE) ON DELETE SET NULL
);
CREATE TABLE GENRE(
